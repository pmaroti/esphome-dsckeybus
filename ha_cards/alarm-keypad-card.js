...
class AlarmKeypadCard extends LitElement {
              ...
              <div class='keypad'>
                ...
                ${this._view_display?html`
                  <div class="keypad_display">
                    ...
                    <div class="keypad_state" id="keypad_state2">P1: ${this._line2}</div>
                    <div class="keypad_state" id="keypad_state3">P2: ${this._line3}</div>
                </div>`:''}
  ...
  if (changedProperties.has("_kpdline1") || changedProperties.has("_kpdline2") || changedProperties.has("_kpdline3")) {
    this.displayChanged();
  }
  ...
  setConfig(config) {
      ...
      if (!config.disp_line3) throw new Error('You need to define a disp_line3');
  ...
  set hass(hass) {
    ...
    this._kpdline3 = this._hass.states[this._config.disp_line3];
  ...
  displayChanged() {
    ...
    for (let i = 0; i < this._kpdline3.state.length; i++) state3 += this._translateChar(this._kpdline3.state[i]);
    this._line1=state1;
    this._line2=state2;
    this._line3=state3;
  }
